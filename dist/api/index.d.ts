 ...
 */
export declare const getBotResponse: (userMessage: string, apiUrl: string, onStreamMessage: (event: MessageData) => void, onStreamMessageError: (error: string) => void) => Promise<void>;
